...
S3DIRECT_REGION = 'us-east-1'  # Replace with your region
...
JAZZMIN_SETTINGS = {
    "site_title": "Mi Admin de Usuarios",
    "site_header": "Rel Plus DB",
    "site_brand": "Rel Plus",
    "welcome_sign": "Bienvenido al panel de administración",
    "copyright": "Vicente ISG Ltd",
    "search_model": ["APP.Usuario"],
    "show_sidebar": True,
    "navigation_expanded": True,
    "order_with_respect_to": ["APP", "auth"], # Apps order in sidebar
    "icons": {
        "auth": "fas fa-users-cog",
        "APP.Usuario": "fas fa-user",
        "APP.Postulacion": "fas fa-file-signature",
